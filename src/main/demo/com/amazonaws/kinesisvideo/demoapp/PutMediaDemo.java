...
public final class PutMediaDemo {
    ...
    private static final String STREAM_NAME = "vrvideostream";

    /* sample MKV file */
   // private static final String MKV_FILE_PATH = "src/main/resources/data/mkv/clusters.mkv";
    
   // private static final String MKV_FILE_PATH = "src/main/resources/data/mkv/output.mkv";
    ...
    public static void main(final String[] args) throws Exception {
        ...
        while (true) {
          ...
          //  final InputStream inputStream = new FileInputStream(MKV_FILE_PATH);
            // from local store --- //
            //String path = "D://Spring-Boot/LiveRecording/output.mkv";
